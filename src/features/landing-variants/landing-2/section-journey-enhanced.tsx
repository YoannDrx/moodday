        ...
        <div className="hidden lg:block">
          <div className="grid grid-cols-2 gap-16">
            ...
            <div className="relative">
              ...
              <div className="via-primary absolute top-0 left-6 h-full w-0.5 bg-gradient-to-b from-amber-400 to-purple-500" />
    ...
    <div className="space-y-4">
      ...
      <div className="rounded-xl bg-white/50 p-4 dark:bg-gray-800/50">
        <div className="flex items-center justify-between">
          ...
          <span className="font-mono text-sm text-amber-600">08:15</span>
        </div>
      </div>
    </div>
  );
  ...
  return (
    <div className="space-y-4">
      <div className="overflow-hidden rounded-xl bg-white/50 dark:bg-gray-800/50">
        ...
        <div className="p-4">
          <p className="text-foreground mb-2 font-semibold">Lithium 400mg</p>
          <div className="flex items-center justify-between">
      ...
      <div className="flex items-center gap-3 rounded-xl bg-white/50 p-4 dark:bg-gray-800/50">
        ...
        <div>
          ...
          <p className="text-muted-foreground text-xs">Pris à 08:00</p>
        </div>
      </div>
    </div>
  );
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="rounded-xl bg-white/50 p-4 dark:bg-gray-800/50">
        ...
        <p className="text-muted-foreground text-sm">
          Votre humeur s&apos;améliore de 15% les jours où vous dormez plus de
          7h.
        </p>
      </div>
    </div>
