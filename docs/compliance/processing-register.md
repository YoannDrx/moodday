...
Dernière revue technique : 23 août 2026
...
| Synchronisation Google Agenda       | Date, heure, fuseau ; titre et lieu uniquement en mode détaillé choisi | Synchroniser les rendez-vous dans un agenda secondaire dédié         | Consentement, art. 6.1.a ; consentement explicite, art. 9.2.a à confirmer      | Google Calendar, Vercel, Neon                               | Vie de la connexion ; arrêt immédiat à la révocation ; agenda Google conservé par défaut    | Opt-in, mode générique, pause, révocation, export, effacement du compte                       |
